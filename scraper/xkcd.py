...
class XKCD():  # noqa: D101
    ...
    def xkcd_crawl(self, start: Optional[int], finish: Optional[int],  # noqa: D102
                   save_path: Optional[str], file_format: Optional[str]) -> None:
        self.process.crawl(XKCDSpider, start, finish, save_path, file_format)
        return

    def xkcd_certain(self,  # noqa: D102
                     start: Optional[int] = None, file_format: Optional[str] = None
